...
public class RollingAppenderCronOnceADayTest {
    ...
    public static void beforeClass() throws Exception {
      ...
      StatusLogger.getLogger().error("Cron experession will be " + cronExpression + " in " + remainingTime + "ms");
    }
    ...
    public void testAppender() throws Exception {
        ...
        logger.debug("Cron experession will be {}", expression.getCronExpression());
